...
import com.telei.wms.commons.annotation.Excel.ColumnType;
import com.telei.wms.commons.annotation.Excel.Type;
import com.telei.wms.commons.annotation.Excels;
...
public class ExcelUtil<T> {
    ...
    public String exportExcel(HttpServletRequest request) {
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=" + setFileDownloadHeader(request, sheetName) + ".xls");
